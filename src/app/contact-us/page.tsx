  ...
  if (isSmallScreen) {
    return (
      <div className="min-h-screen bg-black text-white" >
        ...
        >
          <h1
            className="text-6xl font-light leading-snug text-center mb-14 max-w-3xl heading-clamp-1 mobile-heading"
            style={{  marginTop: '40px'  }} >
            Stories that scream success <br/>are now just a call away!
          </h1>
          ...
          <div className="relative w-full max-w-[1400px] mx-auto min-h-[800px]">
            ...
            <div className="container-flex">
                  ...
                  <div className="contact-info-vertical">
                    ...
                    <span className="address-text">
                      {isSmallScreen 
                        ...
                        : <>No. 1357, Ground Floor, 9th Cross,<br />ITI Layout, JP Nagar 1st Phase,<br />Bengaluru, Karnataka - 560 078.</>
                      }
                    </span>
                  </div>
                </div>
              ...
              <div className="form-area" style={{ marginBottom: 0 }}>
                <ContactForm />
              </div>
            </div>
          </div>
     ...
     return (
      <div className="min-h-screen bg-black text-white">
        ...
        >
          <h1 className="text-6xl font-light leading-snug text-center mb-14 max-w-3xl" style={{  marginTop: '40px'  }}>
          ...
          <div className="relative w-full max-w-[1400px] mx-auto min-h-[800px]">
            ...
            <div className="relative z-10 flex flex-col md:flex-row h-full container-panels" style={{ gap: "1px" }}>
              <div
                className="md:w-1/2 p-0 flex flex-col left-panel"
                style={{ transform: "translate(130px, 120px)", minWidth: "300px" }}
              >
                ...
                <div className="flex" style={{ marginTop: "1px", gap: "24px" }}>
                  <Image src="/contactUsImg/x.webp" alt="X" width={25} height={25} />
                  <a href="https://www.instagram.com/geekonomy_tech" target="_blank" rel="noopener noreferrer">
                    <Image src="/contactUsImg/instagram.webp" alt="Instagram" width={25} height={25} />
                  </a>
                  <a href="https://www.facebook.com/geekonomytechpvtltd" target="_blank" rel="noopener noreferrer">
                    <Image src="/contactUsImg/facebook.png" alt="Facebook" width={25} height={25} />
                  </a>
                </div>
              </div>
              <div className="md:w-1/2 p-0 flex items-center right-panel" style={{ paddingTop: "120px" ,marginBottom: 0}}>
                <ContactForm />
              </div>
            </div>
          </div>
