...
export default function CTASection({ extraSpacing = false }: CTASectionProps) {
  return (
    <section className={`bg-black ${extraSpacing ? 'pt-16 md:pt-24 lg:pt-32' : 'pt-4 md:pt-6 lg:pt-8'} pb-20 md:pb-28 lg:pb-36`}>
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col items-center">
             <Link href="/contact-us">
               <button className="bg-yellow-400 text-gray-950 px-32 md:px-40 lg:px-48 py-1 md:py-1 lg:py-1 rounded-full text-sm md:text-base lg:text-base  hover:bg-yellow-300 transition-colors duration-300">
                 Get In Touch
               </button>
             </Link>
          </div>
