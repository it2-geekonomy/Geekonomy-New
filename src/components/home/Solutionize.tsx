...
export default function Solutionize() {
    return (
      <section className="w-full bg-black text-white pt-6 sm:pt-20 lg:py-32">
        <div className="px-8 sm:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-[30%_70%] gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-4 sm:space-y-6 xl:space-y-8 lg:mr-24 2xl:mr-52 ">
              <h1 className="text-3xl sm:text-4xl md:text-5xl 2xl:text-6xl font-bold text-white leading-tight flex justify-center lg:justify-start">
                We Solutionize.
              </h1>
              
              <div className="space-y-6  text-justify  flex flex-col">
                <p className="text-lg xl:text-[clamp(5px,4vh,23px)] text-white leading-relaxed">
              ...
              <div className="pt-2 flex justify-center lg:justify-start">
                <Link href="/about-us">
                <button className="px-8 py-3 border-2 border-[#FFC700] text-white rounded-lg hover:bg-[#FFC700] hover:text-black transition-all duration-300 font-medium text-base  xl:text-[clamp(5px,4vh,23px)] ">
                  Learn More
                </button>
                </Link>
              </div>
