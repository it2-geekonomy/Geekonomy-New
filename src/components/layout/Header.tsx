      ...
      <div className="flex justify-between items-center w-full max-w-[95%] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ul className="hidden lg:flex items-center gap-8 xl:gap-16 2xl:gap-32 list-none">
          ...
          >
            ...
            {/* Dropdown Menu */}
            <div className={`absolute top-full left-1/2 transform -translate-x-1/2 mt-1 bg-[#040509] w-[200px] rounded-lg shadow-2xl border transition-all duration-300 ease-in-out origin-top ${
              dropdownOpen ? 'opacity-100 scale-y-100 translate-y-0 ' : 'opacity-0 scale-y-0 -translate-y-2 pointer-events-none border-gray-800'
                ...
                <div className="py-4 flex flex-col gap-2">
                  <Link
                    ...
                    className="text-white px-6 py-3 no-underline hover:bg-[#FFC700] hover:text-black transition-all duration-200 text-base font-light rounded-lg mx-2 text-center flex items-center justify-center"
                    onClick={handleNavLinkClick}
                  >
                    Branding Solutions
                  </Link>
